...
class ReadOnlyIntBufferFactoryTest {
    private static final String FACTORY_METHOD = "com.brandontoner.IntBufferFactory#readOnlyFactories";
    ...
    @ParameterizedTest
    @MethodSource(FACTORY_METHOD)
    void copyOf_isReadOnly(final IntBufferFactory factory) {
        assertTrue(factory.copyOf(new int[0]).isReadOnly());
    }
