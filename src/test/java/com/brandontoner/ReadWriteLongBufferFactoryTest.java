...
class ReadWriteLongBufferFactoryTest {
    private static final String FACTORY_METHOD = "com.brandontoner.LongBufferFactory#readWriteFactories";
    ...
    @ParameterizedTest
    @MethodSource(FACTORY_METHOD)
    void copyOf_isReadWrite(final LongBufferFactory factory) {
        assertFalse(factory.copyOf(new long[0]).isReadOnly());
    }
