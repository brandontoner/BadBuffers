...
class ReadOnlyByteBufferFactoryTest {
    private static final String FACTORY_METHOD = "com.brandontoner.ByteBufferFactory#readOnlyFactories";
    ...
    @ParameterizedTest
    @MethodSource(FACTORY_METHOD)
    void copyOf_isReadOnly(final ByteBufferFactory factory) {
        assertTrue(factory.copyOf(new byte[0]).isReadOnly());
    }
