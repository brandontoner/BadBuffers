...
class ReadOnlyShortBufferFactoryTest {
    private static final String FACTORY_METHOD = "com.brandontoner.ShortBufferFactory#readOnlyFactories";
    ...
    @ParameterizedTest
    @MethodSource(FACTORY_METHOD)
    void copyOf_isReadOnly(final ShortBufferFactory factory) {
        assertTrue(factory.copyOf(new short[0]).isReadOnly());
    }
