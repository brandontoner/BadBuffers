...
class ReadWriteDoubleBufferFactoryTest {
    private static final String FACTORY_METHOD = "com.brandontoner.DoubleBufferFactory#readWriteFactories";
    ...
    @ParameterizedTest
    @MethodSource(FACTORY_METHOD)
    void copyOf_isReadWrite(final DoubleBufferFactory factory) {
        assertFalse(factory.copyOf(new double[0]).isReadOnly());
    }
