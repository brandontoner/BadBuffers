...
class ReadOnlyFloatBufferFactoryTest {
    private static final String FACTORY_METHOD = "com.brandontoner.FloatBufferFactory#readOnlyFactories";
    ...
    @ParameterizedTest
    @MethodSource(FACTORY_METHOD)
    void copyOf_isReadOnly(final FloatBufferFactory factory) {
        assertTrue(factory.copyOf(new float[0]).isReadOnly());
    }
