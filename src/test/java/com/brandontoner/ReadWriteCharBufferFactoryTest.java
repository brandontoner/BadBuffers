...
class ReadWriteCharBufferFactoryTest {
    private static final String FACTORY_METHOD = "com.brandontoner.CharBufferFactory#readWriteFactories";
    ...
    @ParameterizedTest
    @MethodSource(FACTORY_METHOD)
    void copyOf_isReadWrite(final CharBufferFactory factory) {
        assertFalse(factory.copyOf(new char[0]).isReadOnly());
    }
