...
/**
 * Provides read-only implementation of {@link ByteBufferFactory}.
 */
class ReadOnlyByteBufferFactory implements ByteBufferFactory {
    /**
     * Delegate factory.
     */
    ...
    @Override
    public ByteBuffer copyOf(final ByteBuffer buffer) {
