...
/**
 * Provides read-only implementation of {@link IntBufferFactory}.
 */
class ReadOnlyIntBufferFactory implements IntBufferFactory {
    /**
     * Delegate factory.
     */
    private final IntBufferFactory factory;
     ...
     */
    ReadOnlyIntBufferFactory(final IntBufferFactory factory) {
    ...
    @Override
    public IntBuffer copyOf(final IntBuffer buffer) {
