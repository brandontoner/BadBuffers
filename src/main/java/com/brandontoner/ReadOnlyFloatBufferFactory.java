...
/**
 * Provides read-only implementation of {@link FloatBufferFactory}.
 */
class ReadOnlyFloatBufferFactory implements FloatBufferFactory {
    /**
     * Delegate factory.
     */
    private final FloatBufferFactory factory;
     ...
     */
    ReadOnlyFloatBufferFactory(final FloatBufferFactory factory) {
    ...
    @Override
    public FloatBuffer copyOf(final FloatBuffer buffer) {
